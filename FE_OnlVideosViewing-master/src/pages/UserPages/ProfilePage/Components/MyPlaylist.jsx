...
import { getPlaylistByUserId } from "../../../../redux/reducers/playlistReducer";
                ...
                return (
                    <div key={playlist._id + Math.random()} className="w-5/6 h-48 mx-auto mb-4 relative flex items-center justify-center">
                        {newestVideos
                            ...
                            .map((video, index) => (
                                <div key={video._id + index} className={`absolute transform`} style={{ zIndex: 40 - index * 10, left: `${0.125 + index * 0.25}rem`, transform: `translateY(${-2.5 + index * 0.25}rem)` }}>
